...
public class ReviewConsumerFunctionTest {
    ...
    public void test() {
        ...
        //System.out.println(getReviewJson());
        testing.thenRun(OssConsumer.class, "handleRequest");
    ...
    private String getReviewJson() {
        return "{\n" +
                ...
                "    \"reviewContent\": \"review content bad2\"\n" +
                "}";
    }
